...
export const TransactionModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col-reverse sm:flex-row items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
